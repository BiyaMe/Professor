...
export default function Home() {
  ...
  return (
    <Box display="flex" justifyContent="space-around" flexGrow={1}>
      <Box>
        <Navbar />
        <Image src="/professor.png" alt="Professor" width={800} height={800} />
      </Box>
      <Box
        width="100vw"
        height="100vh"
        ...
        >
          ...
          >
            {messages.map((message, index) => (
              ...
              >
                <Box
                  bgcolor={message.role === "assistant" ? "#5e3557" : "white"}
          ...
          <Stack
            ...
            sx={{
              ...
              maxHeight: "60px",
              bgcolor: "white",
              border: "1px solid #5e3557",
            }}
          >
            <TextField
              placeholder="Ask Rate your Professor Bot anything.."
              fullWidth
              value={message}
